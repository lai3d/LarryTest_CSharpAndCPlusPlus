...
//namespace _13_Collections_SortedSet
//{
//    class Program
//    {
...
class Program
{
    static void Main(string[] args)
    {
        try
        {
            ...
            IEnumerable<string> files1 = Directory.EnumerateFiles(@"\\archives\2007\media", "*", SearchOption.AllDirectories);
            ...
            IEnumerable<string> files2 = Directory.EnumerateFiles(@"\\archives\2008\media", "*", SearchOption.AllDirectories);
